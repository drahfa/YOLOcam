function boxes = yoloPlot (contain, cellProb, cellIndex, outArray, classMaxIndex, classLabels, plotflag)
% yoloPlot: put object containing box coordinates and other relevant information in a cell array
if nargin < 7
    plotflag = 0;
end
